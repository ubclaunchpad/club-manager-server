...
/** Creates a client using the API key from keys.json file */
const client = new google.auth.JWT(keys.client_email, null, keys.private_key, [
    'https://www.googleapis.com/auth/spreadsheets',
]);

/** Authorizes the client for access to Sheets API */
const authorize = () => {
...
/**
 * Parses applicant data from given Google sheet URL and name
 * Note: the sheet must to open to access by URL or must give the Google service account email (found in keys.json)
 *       access
